...
> For new installations, use the [Wayfinder app](README.md). This document
> preserves the former standalone plugin contracts for migration and recovery.
> The app-bundled companion contains no installer or provider setup controls.
> Do not use the commands below to install a new copy of Wayfinder.
